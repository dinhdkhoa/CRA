...
export default function Students() {
  ...
  return (
    <div>
      <Link
        to='/students/add'
        className=' mt-6 rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300  dark:bg-blue-600 '
      >
        Add Students
      </Link>
                      ...
                      <li key={pageNumber}>
                        <Link
                          className={classNames(
                            'border border-gray-300   py-2 px-3 leading-tight  hover:bg-gray-100 hover:text-gray-700 hover:text-gray-700',
                            {
